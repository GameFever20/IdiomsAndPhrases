...
/**
 * Created by Aisha on 2/20/2018.
 */

public class AppRater {

    private final static String APP_TITLE = "Idioms and Phrases";// App Name
    private final static String APP_PNAME = "app.phrases.idiom.admin.craftystudio.idiomsandphrases";// Package Name
